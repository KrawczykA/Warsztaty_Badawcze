...
# Konfiguracja
class Config:
    def __init__(self, test_datasets=['cifar10', 'cifar100'], train_datasets=['cifar100', 'imagenet'],
                 methods=['mae', 'byol', 'simclr']):
...
def get_dataset(dataset_name, train=True):
    ...
    if dataset_name == 'cifar10':
        ...
        path = os.path.join('data',
                            'imagenet-object-localization-challenge/ILSVRC/Data/CLS-LOC/train') if train else os.path.join(
            'data', 'imagenet-object-localization-challenge/ILSVRC/Data/CLS-LOC/val')
